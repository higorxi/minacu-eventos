...
import { Calendar, MapPin, Music, Theater, Users, ArrowRight, Star, Ticket } from 'lucide-react'
    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          <Link className="text-sm font-medium hover:underline underline-offset-4" href="/eventos">
            Eventos
          </Link>
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-8">Por que escolher MinaçuEventos?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                <Star className="h-12 w-12 text-primary mb-4" />
                <h3 className="text-xl font-bold mb-2">Eventos de Qualidade</h3>
                <p className="text-gray-600">Curadoria cuidadosa de eventos para garantir as melhores experiências.</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <Ticket className="h-12 w-12 text-primary mb-4" />
                <h3 className="text-xl font-bold mb-2">Compra Fácil</h3>
                <p className="text-gray-600">Processo de compra de ingressos simples e seguro.</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <MapPin className="h-12 w-12 text-primary mb-4" />
                <h3 className="text-xl font-bold mb-2">Eventos Locais</h3>
                <p className="text-gray-600">Foco em eventos da região de Minaçu para valorizar a cultura local.</p>
              </div>
            </div>
          </div>
        </section>
